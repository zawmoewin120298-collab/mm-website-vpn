...
# 🛡️ တကယ်လို့ ဆရာက Cloudflare Tunnel သုံးဖို့ Variable ထည့်ခဲ့ရင် ၎င်းကိုပါ တွဲမောင်းပေးခြင်း
if [ ! -z "$TUNNEL_TOKEN" ]; then
  ...
  # Tunnel Token မပါရင် Containerကြီး မပိတ်သွားအောင် ရှေ့တန်းမှာ ထိန်းထားခိုင်းခြင်း
  wait -n
fi
